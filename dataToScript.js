...
function getObject(id,data,indent){
    ...
    objCode=`object "${convertToString(obj1.name)}" ("image"="${obj1.filename}",${((obj1.filename=="text-object.png")?(`"text"="${obj1.text}",`):"")}"x"=${obj1.xPosition},"y"=${obj1.yPosition},"rotation"=${obj1.rotation}) {\n`
