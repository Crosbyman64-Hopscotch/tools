...
function getObject(id,data,indent){
    ...
    objCode=`object "${convertToString(obj1.name)}"=(type:${getValueRef(obj1.type,chars).type},${((obj1.type==2000)?(`image:"${obj1.filename}",`):"")}${((obj1.type==1)?(`text:"${obj1.text}",`):"")}x:${obj1.xPosition},y:${obj1.yPosition}`
